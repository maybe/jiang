<div id="travels-content" class="centered" style="<?php 
  ...
  <?php 
    ...
    <div id="left-arrow" next="<?php echo $index==0?"":"/fr/travels?index=".($index-1) ?>"></div>
    <div id="right-arrow" next="<?php echo $index==count($travels)-1?"":"/fr/travels?index=".($index+1) ?>"></div>
    </div>
  <?php } else {?>
