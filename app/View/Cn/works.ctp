<div id="works-content" class="centered" style="<?php 
  ...
  <?php 
    ...
    <div id="show-frame" class="vert-img"><img src="<?php echo "/img/works/".$works[$index] ?>">
    ...
    <div id="left-arrow" next="<?php echo $index==0?"":"/cn/works?index=".($index-1) ?>"></div>
    <div id="right-arrow" next="<?php echo $index==count($works)-1?"":"/cn/works?index=".($index+1) ?>"></div>
    </div>
  <?php } else {?>
