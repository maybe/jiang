<div id="works-content" class="centered" style="<?php 
  ...
  <div id="img-context">
    ...
    <div id="left-arrow" next="<?php echo $index==0?"":"/cn/works?index=".($index-1)."&cat=".$cat ?>"></div>
    <div id="right-arrow" next="<?php echo $index==count($works)-1?"":"/cn/works?index=".($index+1)."&cat=".$cat ?>"></div>
